        ...
        <label>Nomor Induk Kependudukan (NIK)*</label>
            <div class="input-group mb-3">
                ...
                <!-- <div class="input-group-prepend">
                    <button type="button" class="btn btn-info" id="btnNIKIbu" >Check</button>
                </div> -->
            </div>
        </div>
    </div>
...
<div id="divBiodataIbu">
    ...
    <div class="row">  
        <div class="col-sm-6">
            ...
            <input type="text" id="inputTempatLahirIbu" name="inputTempatLahirIbu"
                class="form-control" placeholder="tempat lahir Ibu" required pattern="[^']+">
            </div>
        </div>
        <div class="col-sm-6">
            <div class="form-group">
    ...
    <div class="row">
        ...
        <input type="hidden" class="form-control" id="emailEmailIbu" name="emailEmailIbu"/>  
    </div>
</div>